...
public abstract class CPU implements iCPU
{
    ...
    {  // Un poco mas "decoroso el string"
    ...
    {  //pendiente de resolucion, por ahora queda en numero
	return cpu.getModel();
    }
    ...
    {
	return "Procesador: " + getFabricanteCPU() + "\n"
		+ "Núcleos Físicos: " + getNucleosFisicosCPU()
		+ " - " + "Núcleos Lógicos: " + getNucleosLogicosCPU() + "\n"
		+ "Arquitectura: " + getArquitecturaCPU();
    }
