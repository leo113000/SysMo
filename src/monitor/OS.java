...
public abstract class OS implements iOS
{
	...
	return String.format("{\"Familia\":%s,\"Version\":%s,\"Fabricante\":%s}", this.getFamiliaOS(), this.getVersionOS(), this.getFabricanteOS());
    ...
    {
	return "Sistema Operativo: " + getFabricanteOS() + "  " + getFamiliaOS()
		+ "\n" + "Versión: " + getVersionOS();
    }
